...
const Page = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-[url('/images/background.jpg')] bg-cover bg-center h-screen text-white">
        <div className="container mx-auto px-6 h-full flex flex-col justify-center items-start space-y-6 ">
          ...
          {/* Heading */}
          <h1 className="text-[40px] md:text-6xl lg:text-7xl  font-bold max-w-4xl font-serif">
