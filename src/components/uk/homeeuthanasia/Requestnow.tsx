      ...
      <div className="text-center">
        ...
        <Link href="/" passHref>
          <div className="flex justify-center">
            <Button
              label="REQUEST NOW"
              className="hover:gap-2 bg-[#0e797d] cursor-pointer font-sans text-white hover:opacity-80 text-[13px] lg:text-[15px] font-medium px-4 py-3 lg:px-6 lg:py-3"
            />
          </div>
        </Link>
        ...
        <p className="mt-1 font-sans text-sm xl:text-base text-[#000000]">
          ...
          <Link
            ...
            className="text-[#000000] font-sans font-medium hover:underline"
          >
            0330 2366 999
          </Link>
        </p>
