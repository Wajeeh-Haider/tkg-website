...
const navigationLinks1 = [
  { label: 'How It Works', href: '/au/how-it-works' },
  { label: 'About Us', href: '/au/about-us' },
  { label: 'Locations', href: '/au/locations' },
  { label: 'Pricing', href: '/au/pricing' },
  { label: 'Blog', href: '/locations' },
  { label: 'FAQs', href: '/au/faqs' },
];

const navigationLinks2 = [
  { label: "Book Your Pet's Home Euthanasia", href: '/about' },
  { label: "Book Your Pet's Collection", href: '/services' },
  { label: 'Aftercare Service', href: '/au/aftercare-services' },
  { label: 'Terms of Service', href: '/au/terms-of-services' },
  { label: 'Privacy Policy', href: '/au/privacy-policy' },
