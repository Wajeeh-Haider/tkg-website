  ...
  return (
    <div className="bg-[#FEFBF8]">
      ...
      <div className="container mx-auto py-16 xl:pr-0 md:pr-4 pr-2 xl:pl-0 pl-2 md:pl-4">
        <h2 className="xl:mt-10 md:mt-10 mt-1  xl:text-[57.76px] md:text-[38.72px] text-[27.68px] font-serif text-primary  lg:mb-0 md:mb-0 mb-1 text-left">
          How It Works
        </h2>
        ...
        <div className="flex flex-col xl:flex-row lg:flex-row md:flex-row flex-wrap justify-center gap-6 ">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="relative flex-1 xl:p-6 p-0 bg-[#FEFBF8] overflow-hidden "
            >
              {/* Background number */}
              ...
              <div className="relative z-10 mt-20">
                <h3 className="xl:text-5xl md:text-[32.32px] text-[25.5px] font-serif text-gray-700 lg:mb-10 mb-5">
                  {step.title}
                </h3>
