    ...
    <div className="bg-[#FEFBF8] py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-6">
          <h1 className="text-[27px] md:text-[38.72px] lg:text-[38.5px] xl:text-[57px] px-3 font-serif text-primary leading-tight">
            {title}
          </h1>
        </div>
                ...
                <div className="lg:mt-8">
                  ...
                  <Link href={card.buttonHref}>
                    <Button
                      ...
                      className="hover:gap-2 hover:opacity-80 text-[14px] text-primary lg:text-[15px] font-bold px-4 py-3 lg:px-6 lg:py-3"
                    />
                  </Link>
                </div>
              </div>
