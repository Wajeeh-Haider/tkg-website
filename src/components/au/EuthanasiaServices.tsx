  ...
  return (
    <div className="bg-[#FEFBF8]">
      <section className=" container mx-auto xl:pr-0 md:pr-4 pr-2 xl:pl-0 pl-2 md:pl-4">
        <div className="text-center xl:mb-15 mb-10 ">
          <h1 className="text-[29px] md:text[38.72px] xl:text-[57.76px] font-serif text-primary ">
        ...
        <div className="flex flex-col md:flex-row gap-7 max-w-8xl mx-auto ">
          {/* Card 1 */}
          <div className="flex-1  bg-secondary xl:p-6 p-2 rounded">
            <div className="flex flex-col md:flex-row items-start gap-4">
              ...
              />
              <div>
                <h3 className="xl:text-[32.16px] text-[22.88px] font-serif lg:mt-10 mt-5">
                  At-Home Pet Euthanasia
                </h3>
                <p className="font-sans text-gray-500 lg:text-[18px] text-[14px] leading-[2] mb-4 mt-5">
                  One of our dedicated vets will visit you to perform your
                  at-home pet euthanasia. From the moment of arrival, everything
                  is done to make the process as peaceful and stress-free as
                  possible for them and you, ensuring we can give your beloved
                  pet the kindest goodbye possible.
                </p>
                <a
                  href="#"
          ...
          {/* Card 2 */}
          <div className="flex-1 bg-[#E4EFF7]  xl:p-6 p-2 rounded">
            <div className="flex flex-col md:flex-row items-start gap-4">
              <img
              ...
              <div>
                ...
                <p className="font-sans text-gray-500  lg:text-[18px] text-[14px]  leading-[2] mb-4 mt-5">
                  ...
                  if you wish to make your own arrangements.
                </p>
                <a
