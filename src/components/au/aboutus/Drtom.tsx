...
function Drtom() {
  return (
    <div className="relative overflow-hidden pt-30 xl:pt-10 pb-10 md:pb-30 xl:pb-40 px-6 md:px-8 lg:px-12 xl:top-[-120]">
