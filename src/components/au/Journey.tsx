      ...
      <div className="w-full max-w-5xl">
        ...
        {step.type === "intro" && (
          <>
            ...
            <p className="font-sans text-[#404040] text-[14px] lg:text-[17px] leading-relaxed">
        ...
        {step.type === "question" && (
          <>
            ...
            <div className="font-sans text-[#404040] text-[14px] lg:text-[17px] leading-relaxed space-y-4">
              {step.points &&
        ...
        {step.type === "total" && (
          <>
            ...
            <p className="text-[14px] lg:text-[17px] font-sans text-[#404040]">
              {getTotalScore()}
            </p>
          </>
        )}
              ...
              <div className="flex flex-wrap items-center gap-4 mb-6">
                <Link href="/au">
                  <Button
                    ...
                    className=" text-[13.125px] lg:text-[17px] bg-primary text-white  px-5 py-3 rounded transition duration-300 hover:bg-teal-600 cursor-pointer"
                  />
                </Link>
                <p className="text-[17px] text-gray-700">or</p>
        ...
        <div className="flex gap-4 mt-8">
          {currentStep > 1 && (
            <Button
              ...
              label="PREVIOUS"
              className="text-[13.125px] lg:text-[17px] px-6 py-4 bg-[#FEFBF8] border-[3px] font-bold border-[#0e797d] text-[#0e797d] rounded hover:border-teal-400 transition duration-300 cursor-pointer"
            />
          )}
