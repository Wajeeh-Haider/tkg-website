    ...
    >
      <div className="container-fluid px-4 md:px-8 flex flex-wrap items-center justify-between relative">
        ...
        <div className="hidden xl:flex flex-1 justify-center">
          <ul
            className={`flex items-center gap-10 text-sm 2xl:text-[18px] font-semibold font-sans transition-colors duration-300 ${
              ...
              after:origin-left after:transition-transform after:duration-300`}
                  ...
                  <Link
                    ...
                    className={`relative block transition-all duration-300 ${
                      isScrolled
                        ? 'text-gray-800 after:bottom-[-32px]'
                        : 'text-white after:bottom-[-58px]'
                    } hover:text-primary 
